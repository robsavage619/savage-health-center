...
Hevy compatibility is non-negotiable: every exercise name MUST appear verbatim in AVAILABLE HEVY EXERCISES in the workout context — this list is both the name source AND the Hevy logging check. If the mechanically optimal exercise for a muscle doesn't exist in the catalog, pick the closest equivalent that does. Never suggest an exercise Rob can't log.
